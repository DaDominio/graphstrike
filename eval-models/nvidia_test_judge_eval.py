#!/usr/bin/env python3
"""Round 2 eval shim for nvidia — delegates to shared _round2_runner."""
...
DEFAULT_HF_MODEL      = os.getenv("MODEL_NAME", "nvidia.nemotron-super-3-120b")
DEFAULT_BEDROCK_MODEL = os.getenv("BEDROCK_MODEL_ID", "nvidia.nemotron-super-3-120b")
