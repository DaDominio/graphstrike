#!/usr/bin/env python3
"""Round 2 eval shim for deepseek — delegates to shared _round2_runner."""
...
DEFAULT_HF_MODEL      = os.getenv("MODEL_NAME", "deepseek.v3.2")
DEFAULT_BEDROCK_MODEL = os.getenv("BEDROCK_MODEL_ID", "deepseek.v3.2")
