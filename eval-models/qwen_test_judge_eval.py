#!/usr/bin/env python3
"""Round 2 eval shim for qwen — delegates to shared _round2_runner."""
...
DEFAULT_HF_MODEL      = os.getenv("MODEL_NAME", "Qwen/Qwen2.5-72B-Instruct")
DEFAULT_BEDROCK_MODEL = os.getenv("BEDROCK_MODEL_ID", "qwen.qwen3-next-80b-a3b")
