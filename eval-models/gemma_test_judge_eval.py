#!/usr/bin/env python3
"""Round 2 eval shim for gemma — delegates to shared _round2_runner."""
...
DEFAULT_HF_MODEL      = os.getenv("MODEL_NAME", "google.gemma-3-12b-it")
DEFAULT_BEDROCK_MODEL = os.getenv("BEDROCK_MODEL_ID", "google.gemma-3-12b-it")
