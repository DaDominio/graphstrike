#!/usr/bin/env python3
"""Round 2 eval shim for llama — delegates to shared _round2_runner."""
...
DEFAULT_HF_MODEL      = os.getenv("MODEL_NAME", "meta.llama4-scout-17b-instruct-v1:0")
DEFAULT_BEDROCK_MODEL = os.getenv("BEDROCK_MODEL_ID", "meta.llama4-scout-17b-instruct-v1:0")
